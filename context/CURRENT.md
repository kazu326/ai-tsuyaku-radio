...
次は、Episode 004「AIと半導体の国家争奪戦」から実制作を再開する。Episode 001〜003で確立したデザイン文法、制作順序、レビュー方法を基準にし、004だけを特別扱いせず、005「DeepSeek：強いGPUだけがAI競争ではない」、006「なぜAI企業はモデルを公開するのか：オープンモデルの経済」まで一続きの第2周として通す。
