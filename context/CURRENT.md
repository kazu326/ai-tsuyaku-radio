...
Web MVPのトップページは、現段階の基準として一旦完成。Episode 001〜003の正式画像と画像共通ルールv0.1も確定した。次は001〜003のコンテンツ制作指示を受け取り、正式画像とともにサイトへ流し込み、NEWSを実データへ置き換える。
...
1. Episode 001〜003のコンテンツ制作指示を受け取る
2. 正式Episode画像と実コンテンツをWebへ流し込み、NEWS 5件を実データへ置き換える
3. 記事・動画・SNSまで反映し、1テーマの制作を「一周」させる
4. コンテンツが揃った状態で、情報量・文字サイズ・余白・Mobile表示をまとめて調整する
5. 共通ルールv0.1と採用画像3点を使い、004以降を一回の指示で生成できるか実制作で検証する
...
次回は、最初にこのファイル、`context/EPISODE_IMAGE_RULES.md`、`web/review/REVIEW.md` を読む。そのうえで、人間側から渡されるEpisode 001〜003のコンテンツ制作指示を確認し、既存のDesktop基準を保ったまま正式画像とコンテンツをWebへ反映する。
